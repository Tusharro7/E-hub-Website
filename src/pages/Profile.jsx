...
//   signOut, 
//   onAuthStateChanged,
//   createUserWithEmailAndPassword, // Naya User banane ke liye
//   signInWithEmailAndPassword,     // Purana User Login ke liye
//   updateProfile                   // Naam save karne ke liye
// } from 'firebase/auth';
// import { toast } from 'react-toastify';
// import { FcGoogle } from 'react-icons/fc';
// import { FiLogOut, FiUser, FiPackage, FiMapPin, FiSettings, FiMail, FiLock } from 'react-icons/fi';
...
//   // --- FORM STATES ---
//   const [isSignup, setIsSignup] = useState(false); // Toggle: Login ya Signup?
//   const [email, setEmail] = useState("");
//   const [password, setPassword] = useState("");
//   const [fullName, setFullName] = useState(""); // Sirf Signup ke liye
...
//     e.preventDefault(); // Form submit hone par page reload roko
//     setLoading(true);
...
//         // 2. Naam update karo (Kyunki email signup mein naam direct save nahi hota)
...
//     } catch (error) {
//       console.error(error);
//       // Error ko sundar dikhane ke liye
...
//   // 1. Agar User Login Nahi Hai -> LOGIN/SIGNUP FORM
//   if (!user) {
//     return (
...
//             {/* Full Name (Sirf Signup ke waqt dikhega) */}
//             {isSignup && (
...
//               type="submit"
//               disabled={loading}
//               className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3 rounded-lg font-bold transition active:scale-95 disabled:opacity-70"
//             >
...
//             className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-white py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-300 font-medium"
//           >
...
//   // 2. Agar User Login Hai -> DASHBOARD UI
//   return (
...
//           {/* Default Image agar photoURL na ho (Manual Login walo ke liye) */}
//           <img 
...
//            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition cursor-pointer flex items-center gap-4">
//               <div className="p-3 bg-blue-100 text-blue-600 rounded-lg"><FiPackage className="text-2xl"/></div>
//               <div><h3 className="font-bold text-gray-800 dark:text-white">My Orders</h3><p className="text-sm text-gray-500">Track orders</p></div>
//            </div>
//            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition cursor-pointer flex items-center gap-4">
//               <div className="p-3 bg-green-100 text-green-600 rounded-lg"><FiMapPin className="text-2xl"/></div>
//               <div><h3 className="font-bold text-gray-800 dark:text-white">Address</h3><p className="text-sm text-gray-500">Manage locations</p></div>
//            </div>
//            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition cursor-pointer flex items-center gap-4">
//               <div className="p-3 bg-purple-100 text-purple-600 rounded-lg"><FiSettings className="text-2xl"/></div>
//               <div><h3 className="font-bold text-gray-800 dark:text-white">Settings</h3><p className="text-sm text-gray-500">Profile settings</p></div>
//            </div>
//         </div>
...
// import React, { useState, useEffect } from 'react';
// // 1. sendPasswordResetEmail import kiya
// import { 
//   auth, 
//   googleProvider 
// } from '../firebaseConfig';
...
//             {/* --- 3. FORGOT PASSWORD LINK (Only for Login Mode) --- */}
//             {!isSignup && (
...
//         {/* Dashboard Grid - AB ISME TEENO OPTIONS HAIN */}
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
